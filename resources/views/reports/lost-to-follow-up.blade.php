      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('lost-to-follow-up') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('lost-to-follow-up') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('lost-to-follow-up.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
            ...
            <option value="{{ url('expired') }}">Died</option>
              ...
              @foreach ($lostToFollowUp as $patients)
                ...
                <tr>
                  ...
                  <td><span class="badge bg-warning">{{ $patients->outcome }}</span></td>
                </tr>
