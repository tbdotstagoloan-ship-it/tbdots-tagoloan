          ...
          <select id="statusRedirect" class="form-select form-select-sm w-auto mb-2" style="width: 235px;">
            ...
            <option value="{{ url('expired') }}">Died</option>
              ...
              <tbody>
                ...
                @foreach ($treatmentCompleted as $patient)
              ...
              <div class="card-footer">Showing {{ $treatmentCompleted->firstItem() }} to {{ $treatmentCompleted->lastItem() }} of
        {{ $treatmentCompleted->total() }} entries
        <div class="mt-2">
          {{ $treatmentCompleted->links() }}
        </div>
      </div>
