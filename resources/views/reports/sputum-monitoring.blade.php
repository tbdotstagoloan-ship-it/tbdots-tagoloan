  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Tracks patients' sputum test results to evaluate treatment response.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('sputum-monitoring') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('sputum-monitoring') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('sputum-monitoring.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
      ...
      <div class="card inventory-card shadow-sm border-0">
        <div class="card-body p-0">
          <div class="table-responsive">
              ...
              <div class="card-footer">Showing {{ $sputum->firstItem() }} to {{ $sputum->lastItem() }} of
        {{ $sputum->total() }} entries
        <div class="mt-2">
          {{ $sputum->links() }}
        </div>
      </div>
