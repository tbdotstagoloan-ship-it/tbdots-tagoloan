  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        List of patients who returned after previous TB treatment.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('relapse') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('relapse') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('relapse.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
          ...
          <div class="table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><span class="badge bg-warning">{{ $patient->clas_registration_group }}</span></td>
                </tr>
              ...
              <div class="card-footer">Showing {{ $relapse->firstItem() }} to {{ $relapse->lastItem() }} of
        {{ $relapse->total() }} entries
        <div class="mt-2">
          {{ $relapse->links() }}
        </div>
      </div>
