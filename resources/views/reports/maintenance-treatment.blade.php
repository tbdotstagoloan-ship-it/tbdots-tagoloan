  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Patients in the continuation phase of TB treatment for sustained recovery.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('maintenance-treatment') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('maintenance-treatment') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('maintenance-treatment.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
        ...
        <div class="card-body p-0">
          ...
          <select id="statusRedirect" class="form-select mb-2" style="width: 220px;">
            ...
            <option value="{{ url('maintenance-treatment') }}">Continuation Phase</option>
              ...
              @foreach ($maintenanceTreatment as $patient)
              ...
              <div class="card-footer">Showing {{ $maintenanceTreatment->firstItem() }} to {{ $maintenanceTreatment->lastItem() }} of
        {{ $maintenanceTreatment->total() }} entries
        <div class="mt-2">
          {{ $maintenanceTreatment->links() }}
        </div>
      </div>
            </div>
          </div>
