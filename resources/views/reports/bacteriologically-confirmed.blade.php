  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Patients with TB confirmed through laboratory tests.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('bacteriologically-confirmed') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('bacteriologically-confirmed') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('bacteriologically-confirmed.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
        ...
        <div class="card-body p-0">
          ...
          <select id="statusRedirect" class="form-select mb-2" style="width: 220px;">
            ...
            <option value="{{ url('clinically-diagnosed') }}">Clinically Diagnosed TB</option>
              ...
              @foreach ($bacteriologicallyConfirmed as $patient)
                ...
                <tr>
                  ...
                  <td><span class="badge bg-success">{{ $patient->tb_classification }}</span></td>
                </tr>
              ...
              <div class="card-footer">Showing {{ $bacteriologicallyConfirmed->firstItem() }} to {{ $bacteriologicallyConfirmed->lastItem() }} of
        {{ $bacteriologicallyConfirmed->total() }} entries
        <div class="mt-2">
          {{ $bacteriologicallyConfirmed->links() }}
        </div>
      </div>
