  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Patients with TB affecting organs other than the lungs.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('extra-pulmonary') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('extra-pulmonary') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('extra-pulmonary.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
        ...
        <div class="card-body p-0">
          ...
          <select id="statusRedirect" class="form-select mb-2" style="width: 210px;">
            ...
            <option value="{{ url('extra-pulmonary') }}">Extra Pulmonary</option>
              ...
              @foreach ($extraPulmonary as $patient)
              ...
              <div class="card-footer">Showing {{ $extraPulmonary->firstItem() }} to {{ $extraPulmonary->lastItem() }} of
        {{ $extraPulmonary->total() }} entries
        <div class="mt-2">
          {{ $extraPulmonary->links() }}
        </div>
      </div>
