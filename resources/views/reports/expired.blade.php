  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Patients who passed away during the course of TB treatment.
      </p>
      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('expired') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('expired') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('expired.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
            ...
            <option value="{{ url('expired') }}">Died</option>
              ...
              @foreach ($expired as $patient)
                ...
                <tr>
                  ...
                  <td><span class="badge bg-danger">{{ $patient->out_outcome }}</span></td>
                </tr>
              ...
              <div class="card-footer">Showing {{ $expired->firstItem() }} to {{ $expired->lastItem() }} of
        {{ $expired->total() }} entries
        <div class="mt-2">
          {{ $expired->links() }}
        </div>
      </div>
