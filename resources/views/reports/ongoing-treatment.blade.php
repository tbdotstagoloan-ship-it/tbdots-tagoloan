...
<body>
  ...
  <div class="main-content py-4" id="mainContent">
    ...
    <p class="text-muted mb-3">
      Patients who are still under TB treatment and currently monitored.
    </p>
    ...
    <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('ongoing-treatment') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('ongoing-treatment') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('ongoing-treatment.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
    ...
    <div class="card inventory-card shadow-sm border-0">
            ...
            <tbody>
              ...
              @foreach ($ongoingPatients as $patient)
                ...
                <tr>
                  ...
                  <td><span class="status-badge bg-secondary">{{ $patient->outcome }}</span></td>
                </tr>
              @endforeach
            </tbody>
          </table>
      ...
      <div class="card-footer">Showing {{ $ongoingPatients->firstItem() }} to {{ $ongoingPatients->lastItem() }} of
        {{ $ongoingPatients->total() }} entries
        <div class="mt-2">
          {{ $ongoingPatients->links() }}
        </div>
      </div>
    </div>
  </div>
