      ...
      <div class="d-flex justify-content-end align-items-center mb-3 position-relative">
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end p-4 shadow-lg border-0 rounded-4" style="width: 320px;">
            ...
            <form method="GET" action="{{ url('clinically-diagnosed') }}" class="row g-3">
              <div class="col-12">
              ...
              <div class="col-12 d-flex justify-content-between align-items-center mt-2">
                <a href="{{ url('clinically-diagnosed') }}" class="btn btn-outline-secondary btn-sm px-3">
                  Reset
                </a>
        ...
        <a href="{{ route('clinically-diagnosed.pdf', ['start_date' => $startDate, 'end_date' => $endDate]) }}" 
            ...
            <option value="{{ url('clinically-diagnosed') }}">Clinically Diagnosed TB</option>
              ...
              @foreach ($clinicallyDiagnosed as $patient)
                ...
                <tr>
                  ...
                  <td><span class="badge bg-warning">{{ $patient->tb_classification }}</span></td>
                </tr>
