...
<body>
          ...
          <form id="form" action="{{ url('validatePage2') }}" method="post" class="p-2" novalidate>
            ...
            <div class="tab-content p-3" id="formTabsContent">
              ...
              <div class="tab-pane fade" id="baseline" role="tabpanel">
                ...
                <div class="row mb-3">
                  <div class="col-md-3">
                    <label for="base_weight">Height</label>
                    <input type="text" name="base_weight" id="trt_height" class="form-control" placeholder="cm">
                    <div class="error"></div>
                  </div>
                  <div class="col-md-3">
                    <label for="base_height">Weight</label>
                    <input type="text" name="base_height" id="trt_weight" class="form-control" placeholder="kg">
                    <div class="error"></div>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="text" name="base_emergency_contact_name" id="trt_emergency_contact"
                      class="form-control" placeholder="In case of emergency">
                    <div class="error"></div>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="text" name="base_contact_info" id="trt_contact_information" class="form-control"
                      placeholder="Contact Information" maxlength="11">
                    <div class="error"></div>
                  </div>
                  <div class="col-md-3">
              ...
              <div class="tab-pane fade" id="medicine" role="tabpanel">
                <div class="row mb-2">
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="drug_name" id="trt_drug" class="form-control form-select">
                      <option value="" disabled selected>Select</option>
                  ...
                  <div class="col-md-3">
                    ...
                    <input type="text" name="drug_unit" id="trt_unit" class="form-control" placeholder="Unit">
                    <div class="error"></div>
                  </div>
                </div>
                ...
                <div class="row mb-2">
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="drug_con_name" class="form-control form-select">
                      <option value="" disabled selected>Select</option>
                      <option value="4FDC">4FDC</option>
                      <option value="2FDC">2FDC</option>
                      <option value="H">H</option>
              ...
              <div class="tab-pane fade" id="admin" role="tabpanel">
                ...
                <div class="row mb-3">
                  <div class="col-md-3">
                    ...
                    <select name="sup_location" id="trt_treatment_location" class="form-control form-select">
                      <option value="" disabled selected>Select</option>
                  ...
                  <div class="col-md-3">
                    ...
                    <select name="sup_type" id="trt_tx_supporter_type" class="form-control form-select">
                      <option value="" disabled selected>Select</option>
                ...
                <div class="row mb-3">
                  <div class="col-md-4">
                    ...
                    <input type="text" name="sup_contact_info" id="trt_tx_supporter_contact" class="form-control"
                      placeholder="Tx Supporter Contact Information" maxlength="11">
                    <div class="error"></div>
                  </div>
                  <div class="col-md-4">
  ...
  <script>
    ...
    form.addEventListener("submit", function (e) {
      ...
      <table class="table table-bordered">
        <tbody>
          ...
          <tr><th colspan="2">A. Baseline Information</th></tr>
          ...
          <tr><th>Height</th><td>${form.base_weight.value}</td></tr>
          <tr><th>Weight</th><td>${form.base_height.value}</td></tr>
          ...
          <tr><th colspan="2">B. Treatment Regimen</th></tr>
          ...
          <tr><th colspan="2">C. Treatment Outcome</th></tr>
          ...
          <tr><th colspan="2">Prescribed Drugs</th></tr>
          ...
          <tr><th colspan="2">D. Administration of Drugs</th></tr>
    ...
    [trt_contact_information, trt_tx_supporter_contact].forEach(input => {
