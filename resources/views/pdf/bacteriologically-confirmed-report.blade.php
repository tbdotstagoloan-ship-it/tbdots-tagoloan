...
<head>
    <meta charset="utf-8">
    <title>Bacteriologically Confirmed TB</title>
    <style>
        body { 
...
<body>
    ...
    <!-- TITLE -->
    <div class="report-title">Bacteriologically Confirmed Tuberculosis Patients Report</div>
    ...
    <table>
        ...
        <tbody>
            @forelse($bacteriologicallyConfirmed as $patient)
            <tr>
