...
<head>
    ...
    <style>
        ...
        td:first-child {
            text-align: left;
            /* Name aligned left for readability */
        }
...
<body>
    ...
    <!-- TITLE -->
    <div class="report-title">Ongoing Treatment Tuberculosis Patients Report</div>
    ...
    <table>
        ...
        <tbody>
            @forelse($ongoingPatients as $patient)
                <tr>
