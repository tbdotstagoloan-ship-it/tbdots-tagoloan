  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      <h4 style="margin-bottom: 10px; color: #2c3e50; font-weight: 600;">
        Quarterly Cases Notification
      </h4>
      <p class="text-muted mb-3">
        Summarizes reported TB cases every quarter for monitoring and evaluation.
      </p>

      <div class="d-flex justify-content-end mb-2 gap-1">
        <a href="{{ route('pdf.quarterly-cases-notification.pdf') }}" target="_blank" class="btn btn-danger">
        ...
        <div class="card-body p-0">
          ...
          <select id="statusRedirect" class="form-select mb-2" style="width: 210px;">
            ...
            <option value="{{ url('quarterly-treatment-outcome') }}">Treatment Outcome</option>
              ...
              @foreach ($quarterlyCasesNotification as $patient)
              ...
              <div class="card-footer">Showing {{ $quarterlyCasesNotification->firstItem() }} to {{ $quarterlyCasesNotification->lastItem() }} of
        {{ $quarterlyCasesNotification->total() }} entries
        <div class="mt-2">
          {{ $quarterlyCasesNotification->links() }}
        </div>
      </div>
