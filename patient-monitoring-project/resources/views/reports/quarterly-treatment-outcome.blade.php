  ...
  <div class="header" id="header">
    ...
    <div class="main-content py-4" id="mainContent">
      ...
      <p class="text-muted mb-3">
        Summarizes patient treatment outcomes on a quarterly basis.
      </p>

      <div class="d-flex justify-content-end mb-2 gap-1">
        <a href="{{ route('pdf.quarterly-treatment-outcome.pdf') }}" target="_blank" class="btn btn-danger">
        ...
        <div class="card-body p-0">
          ...
          <select id="statusRedirect" class="form-select mb-2" style="width: 210px;">
            ...
            <option value="{{ url('quarterly-treatment-outcome') }}">Treatment Outcome</option>
              ...
              @foreach ($quarterlyOutcome as $patient)
              ...
              <div class="card-footer">Showing {{ $quarterlyOutcome->firstItem() }} to {{ $quarterlyOutcome->lastItem() }} of
        {{ $quarterlyOutcome->total() }} entries
        <div class="mt-2">
          {{ $quarterlyOutcome->links() }}
        </div>
      </div>
